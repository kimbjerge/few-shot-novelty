...
from FewShotModelData import EmbeddingsModelFC2, FewShotDataset
...
def classicTrain(model, modelName, train_loader, val_loader, few_shot_classifier,  n_epochs=200):
    ...
    #scheduler_milestones = [500, 1000] # From scratch with 2500 epochs
...
if __name__=='__main__':
    ...
    if args.model == 'resnet50':
        ...
        modelName = "./models/Resnet50_" + args.dataset + '_' + args.mode + "FC2.pth"
        model = EmbeddingsModelFC2(NetModel, num_classes, use_fc=n_use_fc)
        
    if args.model == 'resnet34':
        print('resnet34')
        #NetModel = resnet34(weights=ResNet34_Weights.IMAGENET1K_V1) # 73.314, 21.8M
        NetModel = resnet34(pretrained=True).to(DEVICE)
        modelName = "./models/Resnet34_" + args.dataset + '_' + args.mode + "FC2.pth"   
        model = EmbeddingsModelFC2(NetModel, num_classes, use_fc=n_use_fc)
    ...
    if args.model == 'resnet18':
        ...
        modelName = "./models/Resnet18_" + args.dataset + '_' + args.mode + "FC2.pth"
        model = EmbeddingsModelFC2(NetModel, num_classes, use_fc=n_use_fc)
