...
if __name__=='__main__':
    ...
    for modelName in os.listdir(args.modelDir):
        if ('.pth' in modelName) and (alphaStr in modelName):
            ...
            resFileName = args.model + '_' + args.dataset + '_' + str(int(args.alpha*10)) + "_novelty_ways_learn.txt"
            ...
            resFileName =  args.model + '_' +  args.dataset + '_' + str(int(args.alpha*10)) + "_novelty_ways_test.txt"
