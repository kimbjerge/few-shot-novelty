...
resultDir = "./result/testT500/" # 500*6 queries made on GPU cluser 
...
if __name__=='__main__':
    ...
    plotPrecisionRecall(dataset, model="resnet34", n_shot=1)
    plotPrecisionRecall(dataset, model="resnet34", n_shot=5)
